 ...
 * @author inykang
 */
public class LogDetailBatchAppl implements Serializable {
    private static final Logger logger = Logger.getLogger(LogDetailBatchAppl.class);
    ...
    public static void main(String... args) throws Exception {
        LogDetailBatchAppl app = new LogDetailBatchAppl();
