 ...
 * @author inykang
 */
public class ProductOrderBatchAppl implements Serializable {
    private static final Logger logger = Logger.getLogger(ProductOrderBatchAppl.class);
    ...
    public static void main(String... args) throws Exception {
        ProductOrderBatchAppl app = new ProductOrderBatchAppl();
    ...
    public void start(String date, String basePath, String orderPath, String outPath, String inPath) {
        ...
        // 고객별 상품별 주문집계(CustProductOrderDaily)
        ...
        // 상품별 주문요약(ProductOrderSummaryDaily)
        ...
        // 컨텐츠별 주문요약(ContentOrderSummaryDaily)
